//coded by Rudi 20250515
//using a Xiao nrf52840 with an MPR121 using a capacitive matrix from DFrobot (https://www.dfrobot.com/product-463.html)
//using most code from AN from https://www.nxp.com/docs/en/application-note/AN4600.pdf#page=7.08
...
void setup() {
  ...
  PreTouchStatus.Touched = false;
  PrevSumX = 0; PrevSX = 0; PrevSumY = 0; PrevSY = 0;
...
void loop() {
  ...
  if (CurrTouchStatus.Touched) {
    ...
    SampSumX = 0; SampSX = 0; SampSumY = 0; SampSY = 0;
  }

  Pol_mouse_dat_arduino();            // Processes data, calculates DX, DY

  // Output calculated data
  // Serial.print("Touched: "); Serial.print(CurrTouchStatus.Touched);
  // Serial.print(" | TS: "); Serial.print(CurrTouchStatus.Reg0, HEX); Serial.print(" ");Serial.print(CurrTouchStatus.Reg1, HEX);
  // // Serial.print(" | SampSX: "); Serial.print(SampSX); // Debugging
  // // Serial.print(" SampSY: "); Serial.print(SampSY); // Debugging
  // Serial.print(" | RawP X: "); Serial.print(CurPosX);
  // Serial.print(" Y: "); Serial.print(CurPosY);
...
Serial.println(DY);
  ...
  if (CurrTouchStatus.Touched) {
    Serial.print("Deltas: ");
    for(int k=0; k<12; k++) {
      Serial.print(ele_delta[k]); Serial.print("\t");
    }
    Serial.println();
  }
  */
